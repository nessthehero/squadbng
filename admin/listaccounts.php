...
if (isset($_POST[adding_user])) {
        ...
        if ($num == 0) {
                ...
                $sql = "INSERT INTO squadmembers VALUES ('', '$_POST[new_name]', '$_POST[new_email]', '$pass', '$_POST[gender]', 0, 0, 0, 'no', 'squad')";
                $result = mysql_query($sql,$connection) or die(mysql_error());
        } else {
...
<form method="post" action="listaccounts.php">
        ...
        <table border="0" width="62%" id="table1">
				...
				<tr>
						<td align="right"><font>Gender:</font></td>
						<td width="194">Male: <input type="radio" name="gender" value="male" checked="checked" /> Female: <input type="radio" name="gender" value="female" /></td>
				</tr>
                <tr>
...
<?
        ...
        while ($row = mysql_fetch_array($result)) {
                ...
                if (check_purge()) {
                        ...
                        } elseif (get_purge_for_user($id) == "new") {
				$purge = "<td align=\"center\" class=\"$rank\"><font color=\"#FFFFFF\"><b>NEW</b></font></td>";
			} else {

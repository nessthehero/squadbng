...
$page_topimg = "squad";
$level = "squad";
$page_title = "Apply to join the squad!";
...
<form method="POST" name="application" action="apply.php">
	...
	<div id="form">
		Desired username:
		<input type="text" name="username" size="20" maxlength="50" <? echo "value=\"$_POST[username]\""; ?>>
	</div>
	<div id="form">
		Desired password:
	...
	<div id="form">
		E-mail Address:
		<input type="text" name="email" size="20" maxlength="100" <? echo "value=\"$_POST[email]\""; ?>>
	</div>
	<br />
	...
	<div id="form">
		...
		<input type="text" name="told_to_join_by" size="20" <? echo "value=\"$_POST[told_to_join_by]\""; ?>>
	</div>
	<div id="form">
